...
if ('serviceWorker' in navigator) {
    ...
    registration.then(function _callee() {
        var controller;
...
var AppClient = function () {
    ...
    _createClass(AppClient, null, [{
        ...
        value: function findWays(fromPositionStr, toPositionStr, myStartTimeStr, my_dopTimeMinutes, my_speed, typesStr) {
            var findedOptimalWays, i;
            return regeneratorRuntime.async(function findWays$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            ...
                            _context2.prev = 1;
                            _context2.next = 4;
                            return regeneratorRuntime.awrap(getCountedOnServerWays(fromPositionStr, toPositionStr, myStartTimeStr, my_dopTimeMinutes, my_speed, typesStr));
                        ...
                        case 7:
                            ...
                            _context2.prev = 9;
                            _context2.next = 12;
                            return regeneratorRuntime.awrap(getCountedOnClientWays(fromPositionStr, toPositionStr, myStartTimeStr, my_dopTimeMinutes, my_speed, typesStr));
        ...
        value: function findCurrentDestinationCoords() {
            ...
            return regeneratorRuntime.async(function findCurrentDestinationCoords$(_context4) {
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            ...
                            getCurrentPosition = function _callee2() {
                                var promise;
                            ...
                            _context4.next = 4;
                            return regeneratorRuntime.awrap(getCurrentPosition());
                        ...
                        case 7:
                            ...
                            _context4.next = 13;
                            return regeneratorRuntime.awrap(AppClient.getDesinationDescription(coords));
                        ...
                        case 13:
                            ...
                            _context4.next = 17;
                            return regeneratorRuntime.awrap(_pointsHistoryStorage2.default.tryFindByCoords(coords));
        ...
        value: function findPointsByOsmGeocodingApi(strReq) {
            var data, resultPoints, i, n, currentPoint;
            return regeneratorRuntime.async(function findPointsByOsmGeocodingApi$(_context5) {
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        case 0:
                            _context5.prev = 0;
                            _context5.next = 3;
                            return regeneratorRuntime.awrap(getJsonFromUrl("https://nominatim.openstreetmap.org/search?q=" + strReq + "&format=json"));
        ...
        value: function getDesinationDescription(coords) {
            var findedPoints;
            return regeneratorRuntime.async(function getDesinationDescription$(_context6) {
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            _context6.prev = 0;
                            _context6.next = 3;
                            return regeneratorRuntime.awrap(AppClient.findPointsByOsmGeocodingApi(coords.lat + "," + coords.lng));
...
function getJsonFromUrl(strReq) {
    var response;
    return regeneratorRuntime.async(function getJsonFromUrl$(_context7) {
        while (1) {
            switch (_context7.prev = _context7.next) {
                case 0:
                    _context7.next = 2;
                    return regeneratorRuntime.awrap(fetch(strReq));
...
function getCountedOnServerWays(fromPositionStr, toPositionStr, myStartTimeStr, my_dopTimeMinutes, my_speed, typesStr) {
    var paramsStr, data;
    return regeneratorRuntime.async(function getCountedOnServerWays$(_context8) {
        while (1) {
            switch (_context8.prev = _context8.next) {
                case 0:
                    ...
                    _context8.next = 3;
                    return regeneratorRuntime.awrap(getJsonFromUrl(apiPublicTransportServer + "optimalRoute" + paramsStr));
...
function getCountedOnClientWays(fromPositionStr, toPositionStr, myStartTimeStr, my_dopTimeMinutes, my_speed, typesStr) {
    ...
    return regeneratorRuntime.async(function getCountedOnClientWays$(_context9) {
        while (1) {
            switch (_context9.prev = _context9.next) {
                ...
                case 6:
                    ...
                    _context9.prev = 11;
                    _context9.next = 14;
                    return regeneratorRuntime.awrap(getOptimalRoutesCollectionFromSw(params));
    ...
    }, null, this, [[11, 19], [22, 32]]);
}

var myResolve; //, myReject;
function getOptimalRoutesCollectionFromSw(params) {
    var promise;
    return regeneratorRuntime.async(function getOptimalRoutesCollectionFromSw$(_context10) {
        while (1) {
